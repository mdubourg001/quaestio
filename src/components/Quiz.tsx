...
export default function Quiz({ quiz }: QuizProps) {
  ...
  if (state === "feedback" && currentAnswer) {
    ...
    const currentCorrectAnswers =
      correctAnswers + (currentAnswer.isCorrect ? 1 : 0);
    ...
    return (
      ...
      >
        <div className="max-w-lg w-full bg-white border-brutal-thick shadow-brutal-hover sharp animate-bounce-in">
          ...
          <div
            className={`p-12 text-center border-b-[3px] border-black ${
          ...
          <div className="p-8 text-center">
            ...
            <div className="grid grid-cols-3 gap-3 mb-8">
              <div className="bg-cyber-blue border-brutal p-2 md:p-4">
              ...
              <div className="bg-black border-brutal p-2 md:p-4">
              ...
              <div className="bg-cyber-purple border-brutal p-2 md:p-4">
                <div className="text-2xl font-black text-white">
                  {currentCorrectAnswers}/{currentQuestionIndex + 1}
                </div>
                <div className="text-xs font-bold text-white uppercase mt-1">
                  Correct
                </div>
